...
{
    private $id, $name_ar, $name_en, $desc_ar, $desc_en, $image, $status, $subcategory_id, $brandd_id, $quantity, $price, $code, $created_at, $updated_at;
    ...
    /**
     * Get the value of brandd_id
     */
    public function getBrandd_id()
    {
        return $this->brandd_id;
    }

    /**
     * Set the value of brandd_id
     *
     * @return  self
     */
    public function setBrandd_id($brandd_id)
    {
        $this->brandd_id = $brandd_id;

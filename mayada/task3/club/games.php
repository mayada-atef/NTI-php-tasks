...
function gamestable(){
    ...
    for($i=1;$i<=$_SESSION['membersCount'];$i++){
     ...
     $games.= 'Member'.$i;
     $games.= '</label>
            <input type="text" name="subscriberName'.$i.'" value="" id="subscriberName" class="form-control"
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
     ...
     array_push($_SESSION['members'],
        ...
        [
           ...
           'membergames'=>[$_POST[('game'.$j.'_member'.$i)]??""]
        ]
        ]);} 
         print_r($_SESSION);
}}

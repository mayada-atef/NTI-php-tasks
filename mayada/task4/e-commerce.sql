...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=182807179ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=orders">`e-commerce`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=subcategories">`e-commerce`.`subcategories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=products">`e-commerce`.`products`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=regions">`e-commerce`.`regions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=addresses">`e-commerce`.`addresses`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=users">`e-commerce`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=order_product">`e-commerce`.`order_product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=payment">`e-commerce`.`payment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=carts">`e-commerce`.`carts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=e-commerce&table=wishlist">`e-commerce`.`wishlist`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="30497d2823724f64775a427d2d456e72">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="241"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>

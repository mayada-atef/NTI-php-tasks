<?php
// model of user similar to users table in database 
//extends from connection for make code of crud operation 
// making implements from crud interface in all models to force it write body of crud funcs
// interface because i don't want to lose single inheretance
...
class user extends connection implements crud
{
    private $id, $first_name, $last_name, $email, $password, $phone, $gender, $image,
        $status, $email_verified_at, $verification_code, $created_at, $updated_at;
